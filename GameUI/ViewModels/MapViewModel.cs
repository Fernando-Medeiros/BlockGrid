...
public sealed partial class MapViewModel : BaseViewModel
{
    ...
    #region Property
    public IList<Tile> Row00 { get; set; } = [];
    ...
    private async void LoadChanged(object sender)
    {
        ...
        Row00 = [.. tier.Matriz[0]]; Row01 = [.. tier.Matriz[1]]; Row02 = [.. tier.Matriz[2]];
        Row03 = [.. tier.Matriz[3]]; Row04 = [.. tier.Matriz[4]]; Row05 = [.. tier.Matriz[5]];
        Row06 = [.. tier.Matriz[6]]; Row07 = [.. tier.Matriz[7]]; Row08 = [.. tier.Matriz[8]];
        Row09 = [.. tier.Matriz[9]]; Row10 = [.. tier.Matriz[10]]; Row11 = [.. tier.Matriz[11]];
        Row12 = [.. tier.Matriz[12]]; Row13 = [.. tier.Matriz[13]]; Row14 = [.. tier.Matriz[14]];
        Row15 = [.. tier.Matriz[15]]; Row16 = [.. tier.Matriz[16]]; Row17 = [.. tier.Matriz[17]];
        Row18 = [.. tier.Matriz[18]]; Row19 = [.. tier.Matriz[19]]; Row20 = [.. tier.Matriz[20]];
        Row21 = [.. tier.Matriz[21]]; Row22 = [.. tier.Matriz[22]]; Row23 = [.. tier.Matriz[23]];

        OnPropertyChanged(nameof(Row00)); OnPropertyChanged(nameof(Row01)); OnPropertyChanged(nameof(Row02));
        OnPropertyChanged(nameof(Row03)); OnPropertyChanged(nameof(Row04)); OnPropertyChanged(nameof(Row05));
        OnPropertyChanged(nameof(Row06)); OnPropertyChanged(nameof(Row07)); OnPropertyChanged(nameof(Row08));
        OnPropertyChanged(nameof(Row09)); OnPropertyChanged(nameof(Row10)); OnPropertyChanged(nameof(Row11));
        OnPropertyChanged(nameof(Row12)); OnPropertyChanged(nameof(Row13)); OnPropertyChanged(nameof(Row14));
        OnPropertyChanged(nameof(Row15)); OnPropertyChanged(nameof(Row16)); OnPropertyChanged(nameof(Row17));
